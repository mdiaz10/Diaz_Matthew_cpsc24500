 ...
 * Section of the Code that Writes to the three different formats, those being Text file, Binary, and XML 
 * Because each format is different each one needs to be handled on its own 
 *
 */
